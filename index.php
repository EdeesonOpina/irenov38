                ...
                <div id="top-bar-inner" class="container">
                    <div class="top-bar-inner-wrap">
                        <div class="top-bar-content">
                            <div class="inner">
                                <span class="address content">114 Chemin du levatel, 38690 Oyeu</span>
                                <span class="phone content">06 77 06 80 24</span>
                        ...
                        <div class="top-bar-socials">
                            <div class="inner">
                                ...
                                <span class="icons">
                                    <a href="https://www.facebook.com/Irenov-830939210348205/"><i class="fa fa-facebook"></i></a>
                                </span>
                            </div>
                        </div><!-- /.top-bar-socials -->
                    </div>                    
                                                    ...
                                                    <div class="themesflat-image-box style-1 has-icon icon-right w65 clearfix">
                                                        <div class="image-box-item">
                                                            <div class="inner">
                                                                ...
                                                                <div class="text-wrap">
                                                                    <h5 class="heading"><a href="#">RENOVATION</a></h5>
                                                    ...
                                                    <div class="themesflat-image-box style-1 has-icon icon-right w65 clearfix">
                                                        <div class="image-box-item">
                                                            <div class="inner">
                                                                ...
                                                                <div class="text-wrap">
                                                                    <h5 class="heading"><a href="#">PLUMBING</a></h5>
                                                                    <span class="icon-wrap">
                                                                        <i class="fa fa-angle-right"></i>
                                                                    </span>
                                                                </div>
                                                        ...
                                                        <div class="testimonial-item">
                                                            <div class="inner">
                                                                ...
                                                                <blockquote class="text">
                                                                    <p>“ I have worked with i'Renov 38 Construction Services for over 10 years, they have consistently delivered fair pricing, quality workmanship and complete projects on schedule. I appreciate the level of customer service they deliver by going above and beyond expectations. ”</p>
                                                                    <div class="sep has-width w80 accent-bg clearfix"></div>
                                                                    <h6 class="name">CYRIL SANSANO</h6>
                                                                </blockquote>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="quote-item">
                                                    <div class="inner">
                                                        ...
                                                        <div class="button-wrap has-icon icon-left">
                                                            <a href="#" class="themesflat-button bg-white small"><span>06 77 06 80 24 <span class="icon"><i class="autora-icon-phone-contact"></i></span></span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="themesflat-headings style-1 text-center clearfix">
                                                ...
                                                <p class="sub-heading font-weight-400 max-width-770 line-height-26 margin-top-14">Are you interested in finding out how i'Renov 38 Construction Services can make your project a success? For more information on our services please contact us.</p>
                                            </div>
                                    ...
                                    <div class="row gutter-16">
                                        <div class="col-md-4">
                                            <div class="themesflat-icon-box icon-top align-center  accent-color style-3 bg-light-snow clearfix">
                                                ...
                                                <div class="text-wrap">
                                                    <h5 class="heading"><a href="#">06 77 06 80 24</a></h5>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="themesflat-icon-box icon-top align-center accent-color style-3 bg-light-snow clearfix">
                                                ...
                                                <div class="text-wrap">
                                                    <h5 class="heading"><a href="#">114 Chemin du levatel 38690 Oyeu</a></h5>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="themesflat-icon-box icon-top align-center accent-color style-3 bg-light-snow clearfix">
                                                ...
                                                <div class="text-wrap">
                                                    <h5 class="heading"><a href="#">irenov38@gmail.com</a></h5>
                                                    <p class="sub-heading">Support 24/7 - Online 24 hours</p>
                                            ...
                                            <div class="themesflat-contact-form style-2 w100 clearfix">
                                                ...
                                                <script>
                                                  hbspt.forms.create({
                                                    region: "na1",
                                                    portalId: "22227720",
                                                    formId: "fd740aaa-c9a5-47c4-bcef-657b538303c0"
                                                  });
                                                </script>
                                ...
                                <ul>
                                    <li>
                                        <div class="inner">
                                            ...
                                            <span class="text">114 Chemin du levatel  <span class="sl">38690 Oyeu</span></span>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="inner">
                                            ...
                                            <span class="text">CALL US : 06 77 06 80 24</span>
                                        </div>
                                    </li>
                                    ...
                                    <li class="margin-top-7">
                                        <div class="inner">
                                            ...
                                            <span class="text">irenov38@gmail.com</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="instagram-wrap data-effect clearfix col3 g10">
                                <div class="instagram_badge_image has-effect-icon">
                                    <a href="#" target="_blank" class="data-effect-item">
                                        <span class="item"><img src="assets/img/instagram/1.jpg" alt="Image" ></span>
                                ...
                                <div class="instagram_badge_image has-effect-icon">
                                    <a href="#" target="_blank" class="data-effect-item">
                                        <span class="item"><img src="assets/img/instagram/2.jpg" alt="Image" ></span>
                                        <div class="overlay-effect bg-color-2"></div>
                                        <div class="elm-link">
                                            <span class="icon-3"></span>
                                        </div>
                                ...
                                <div class="instagram_badge_image has-effect-icon">
                                    <a href="#" target="_blank" class="data-effect-item">
                                        <span class="item"><img src="assets/img/instagram/3.jpg" alt="Image"></span>
                                        <div class="overlay-effect bg-color-2"></div>
                                        <div class="elm-link">
                                            <span class="icon-3"></span>
                                        </div>
                                ...
                                <div class="instagram_badge_image has-effect-icon">
                                    <a href="#" target="_blank" class="data-effect-item">
                                        <span class="item"><img src="assets/img/instagram/4.jpg" alt="Image"></span>
                                        <div class="overlay-effect bg-color-2"></div>
                                        <div class="elm-link">
                                            <span class="icon-3"></span>
                                        </div>
                                ...
                                <div class="instagram_badge_image has-effect-icon">
                                    <a href="#" target="_blank" class="data-effect-item">
                                        <span class="item"><img src="assets/img/instagram/5.jpg" alt="Image"></span>
                                        <div class="overlay-effect bg-color-2"></div>
                                        <div class="elm-link">
                                            <span class="icon-3"></span>
                                        </div>
                                ...
                                <div class="instagram_badge_image has-effect-icon">
                                    <a href="#" target="_blank" class="data-effect-item">
                                        <span class="item"><img src="assets/img/instagram/6.jpg" alt="Image"></span>
                                        <div class="overlay-effect bg-color-2"></div>
                                        <div class="elm-link">
                                            <span class="icon-3"></span>
                                        </div>
